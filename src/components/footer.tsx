        ...
        <footer className="text-gray-500 bg-white px-4 py-5 max-w-screen-xl mx-auto md:px-8">
            <div className="max-w-lg sm:mx-auto sm:text-center">
                <div className="flex items-center justify-center space-x-2">
                    <span className="text-3xl font-bold text-red-600">HIV</span>
                    <span className="text-3xl font-bold text-gray-600">&</span>
                    <span className="text-3xl font-bold text-red-600">AIDS</span>
                </div>
                <p className="leading-relaxed mt-2 text-[15px]">
                    Providing comprehensive HIV/AIDS information, support, and resources to help individuals and communities lead healthier lives.
                </p>
            </div>
            ...
            <div className="mt-8 items-center justify-between sm:flex">
                <div className="mt-4 sm:mt-0">
                    &copy; {new Date().getFullYear()} HIV/AIDS Resource Center. All rights reserved.
                </div>
                <div className="mt-6 sm:mt-0">
                    <ul className="flex items-center space-x-4">
                        <li className="w-10 h-10 border rounded-full flex items-center justify-center hover:bg-gray-100">
